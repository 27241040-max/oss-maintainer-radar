...
- `dist/oss_maintainer_radar-0.14.0.tar.gz`
- `dist/oss_maintainer_radar-0.14.0-py3-none-any.whl`
...
/tmp/oss-radar-wheel-check/bin/python -m pip install dist/oss_maintainer_radar-0.14.0-py3-none-any.whl
