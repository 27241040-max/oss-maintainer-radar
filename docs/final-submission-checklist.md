...
oss-radar form-fields --repo 27241040-max/oss-maintainer-radar --evidence evidence.json --role primary --output reports/form-fields.md
oss-radar submission-pack --repo 27241040-max/oss-maintainer-radar --evidence evidence.json --role primary --output reports/submission-pack.md
```
